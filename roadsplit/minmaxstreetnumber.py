...
query=pysql("select min(geocodio_AddressNumber),min(geocodio_AddressNumber),geocodio_Street from data where geocodio_city='Charlotte' group by geocodio_Street")
# size=query.shape[0]
